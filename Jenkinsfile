...
execCommand: "/home/docker/shell/deploy.sh $harbor_url $harbor_project_name $currentProjectName $tag $currentProjectPort $activeProfile", execTimeout: 120000000, flatten: false, makeEmptyDirs: false,
