...
import com.huangpuguang.system.service.*;
...
public class SysUserController extends BaseController
{
    ...
    public ResultModel<LoginUser> info(@PathVariable("username") String username)
    {
        ...
        return ResultModel.ok(sysUserVo);
    }
    ...
    public ResultModel<Boolean> register(@RequestBody SysUser sysUser)
    {
        String username = sysUser.getUserName();
        if (!("true".equals(configService.selectConfigByKey("sys.account.registerUser"))))
        {
            return ResultModel.fail("当前系统没有开启注册功能！");
        }
        if (UserConstants.NOT_UNIQUE.equals(userService.checkUserNameUnique(username)))
        {
            return ResultModel.fail("保存用户'" + username + "'失败，注册账号已存在");
        }
        return ResultModel.ok(userService.registerUser(sysUser));
    }
    ...
    public AjaxResult edit(@Validated @RequestBody SysUser user)
    {
        ...
        if (ProconStringUtils.isNotEmpty(user.getPhonenumber())
                && UserConstants.NOT_UNIQUE.equals(userService.checkPhoneUnique(user)))
        {
     ...
     * 获取用户信息
     */
    @GetMapping("/info/{username}/{source}")
    public SysUser info(@PathVariable("username") String username,@PathVariable("source")String source)
    {
        return userService.selectUserByUserNameAndSource(username, source);
    }
    ...
    {
        return  userService.updateOrInsertUser(sysUser);
    }
